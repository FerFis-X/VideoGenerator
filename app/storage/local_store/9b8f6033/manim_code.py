...
class SolutionScene(Scene):
    def construct(self):
        ...
        # Paso 1
        step_1_tex = Tex(r"Paso 1: (x - 3)*(x - 2) = 0")
        rule_1_tex = Tex(r"Regla: factorización")
        narr_1_tex = Tex(r"Factorizamos el trinomio en dos binomios.")
        

        # Paso 2
        step_2_tex = Tex(r"Paso 2: x=2 o x=3")
        rule_2_tex = Tex(r"Regla: propiedad del producto nulo")
        narr_2_tex = Tex(r"Si un producto es cero, uno de los factores debe anularse.")
        

        # Paso 3
        step_3_tex = Tex(r"Paso 3: x = 2, x = 3")
        rule_3_tex = Tex(r"Regla: aislar la variable")
        narr_3_tex = Tex(r"Resolvemos cada ecuación lineal para encontrar los valores de la incógnita.")
