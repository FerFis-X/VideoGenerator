...
class SolutionScene(Scene):
    def construct(self):
        title = Text("Problema: x**2 - 5*x + 6 = 0", font_size=36)
        ...
        # Paso 1
        step_1 = Text("Paso 1: (x - 3)*(x - 2) = 0", font_size=32)
        ...
        # Paso 2
        step_2 = Text("Paso 2: x=2 o x=3", font_size=32)
        ...
        # Paso 3
        step_3 = Text("Paso 3: x = 2, x = 3", font_size=32)
        ...
        final_txt = Text("Solución: x = 2 , x = 3", font_size=36)
