...
class SolutionScene(Scene):
    def construct(self):
        title = Text("Problema: 9*x**2 + 6*x + 3 = 0", font_size=36)
        ...
        # Paso 1
        step_1 = Text("Paso 1: 3*(3*x**2 + 2*x + 1) = 0", font_size=32)
        ...
        # Paso 2
        step_2 = Text("Paso 2: x=-1/3 - sqrt(2)*I/3 o x=-1/3 + sqrt(2)*I/3", font_size=32)
        ...
        # Paso 3
        step_3 = Text("Paso 3: x = -1/3 - sqrt(2)*I/3, x = -1/3 + sqrt(2)*I/3", font_size=32)
        ...
        final_txt = Text("Solución: x = -1/3 - sqrt(2)*I/3 , x = -1/3 + sqrt(2)*I/3", font_size=36)
